<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shebie_admin.aspx.cs" Inherits="shebie_admin" %>
        ...
        <td colspan="16" align="center" class=txlrow>
            <asp:GridView ID="GridView1"   AutoGenerateColumns="False"     OnPageIndexChanging="GridView1_PageIndexChanging" CssClass="tab"  runat="server" Width="100%" DataKeyNames="id">
                        <Columns>
                            ...
                            <asp:BoundField DataField="wname" HeaderText="名称" />                                                          
                            <asp:TemplateField HeaderText="操作" >
            <ItemTemplate>
 <a href="shebie_delete.aspx?id=<%# Eval("id") %>" >删除</a> &nbsp;&nbsp;<a href="shebie_Edit.aspx?id=<%# Eval("id") %>" >修改</a> 
  </ItemTemplate> 
              </asp:TemplateField>
