          ...
          <tr bgcolor="#DEE5FA">
           ...
           <tr bgcolor="#DEE5FA">
            <td height="29" align="right" class="txlrow">
                用户名:</td>
            <td align=left class=txlrow>&nbsp;<asp:TextBox ID="username" runat="server" Width="145px"></asp:TextBox>&nbsp;
            ...
            <td height="29" align="right" class="txlrow">
                密码:</td>
            <td align=left class=txlrow>&nbsp;<asp:TextBox ID="password" TextMode="Password" runat="server" Width="144px"></asp:TextBox>&nbsp;
