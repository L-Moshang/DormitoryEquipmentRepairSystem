          ...
          <tr bgcolor="#DEE5FA">
           ...
           <tr bgcolor="#DEE5FA">
            <td height="29" align="right" class="txlrow">
                学号:</td>
            <td align=left class=txlrow>&nbsp;<asp:TextBox ID="stuno" ReadOnly="true" runat="server" Width="145px"></asp:TextBox>&nbsp;
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="stuno" runat="server" ErrorMessage="请输入学号"></asp:RequiredFieldValidator>
                <asp:Label ID="ids"  Visible="false" runat="server" Text="Label"></asp:Label></td>
          </tr>
